    ...
    <header className="bg-fullwhite dark:bg-fullblack h-20 flex items-center px-4">
      <div className="flex w-full justify-between items-center">
        ...
        <div className="flex items-center">
          <svg width="auto" height="25" viewBox="0 0 39 40" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <span className="text-2xl font-bold pl-3 text-info">W</span>
          <span className="text-2xl font-bold  text-dark dark:text-ligth">orkif</span>
          <span className="text-2xl font-bold text-interact">y</span>
        </div>
        <div className="flex items-center space-x-4">
          {token ? (
            <>
