...
export default function Home() {
  return (
    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-poppins">
      ...
      <main className="flex flex-col gap-8 row-start-2 items-center sm:items-start add-card ">
        <Image
          ...
          priority
        />
        <ol className="list-inside list-decimal text-sm text-center sm:text-left text-info">
          <li className="mb-2">
        ...
        <div className="flex gap-4 items-center flex-col sm:flex-row">
          <a
            className="button transition-colors hover:underline hover:text-info flex items-center justify-center gap-2 hover:bg-interact text-fullblack dark:text-fullwhite text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5"
          ...
          <a
            className="button transition-colors hover:underline hover:text-info hover:bg-interact text-fullblack dark:text-fullwhite flex items-center justify-center text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5 sm:min-w-44"
