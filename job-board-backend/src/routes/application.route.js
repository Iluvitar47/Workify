...
router.patch('/:id', auth(Role.Admin), updateApplicationSchema, awaitHandlerFactory(ApplicationControllers.updateApplication)); // localhost:5558/api/v1/applications/:id
