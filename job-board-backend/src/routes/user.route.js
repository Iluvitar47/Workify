...
router.get('/id/:id', awaitHandlerFactory(userController.getUserById)); // localhost:5558/api/v1/users/id/1
...
router.patch('/id/:id', auth(Role.Admin), updateUserSchema, awaitHandlerFactory(userController.updateUser)); // localhost:5558/api/v1/users/id/1
router.delete('/id/:id', auth(Role.Admin), awaitHandlerFactory(userController.deleteUser)); // localhost:5558/api/v1/users/id/1
